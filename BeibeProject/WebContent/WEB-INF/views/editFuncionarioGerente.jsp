                            ...
                            <form id="formUsuario" method="POST" data-type="updateUsuario">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="nome" id="nome" maxlength="50" value="${usuario.nome}" placeholder="Nome" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="telefone" value="${usuario.telefone}" maxlength="15" name="telefone" placeholder="(00) 0000-0000" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="cep">CEP</label>
                                        <input type="text" class="form-control" id="cep"  value="${usuario.endereco.cep}" name="cep" maxlength="8" placeholder="00000-000" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="bairro">Bairro</label>
                                        <input type="text" class="form-control" name="bairro" maxlength="50" value="${usuario.endereco.bairro}" id="bairro" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="feInputState">Rua</label>
                                        <input type="text" class="form-control" id="rua" value="${usuario.endereco.rua}" name="rua" maxlength="100" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="complemento">Complemento</label>
                                        <input type="text" class="form-control" id="complemento" value="${usuario.endereco.complemento}" name="complemento" maxlength="255" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="numero">Numero</label>
                                        <input type="number" class="form-control" id="numero" value="${usuario.endereco.numero}"  name="numero" maxlength="10" required>
                                    </div>
                                </div>
                                <div class="form-row">
