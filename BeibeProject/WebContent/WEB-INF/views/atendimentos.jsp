                            ...
                            <tr>
                                ...
                                <c:choose>
                                  <c:when test="${a.status == 'A'}">
                                    <a href="#" class="badge badge-pill badge-success">Aberto</a>
                                  </c:when>
                                  <c:otherwise>
                                     <a href="#" class="badge badge-pill badge-danger">Finalizado</a>
                                  </c:otherwise>
                                </c:choose>
                                ...
                                <td>                            
                                  <c:if test="${login.tipo == 'F'}" >
                                      <c:choose>
                                        ...
                                        <c:otherwise>
                                            <span class="pointer" data-id="${a.id}">
